...
export declare class SmoothScrollManager {
     ...
     */
    private get _now();
    constructor(_document: Document, _platform: object, customDefaultOptions: SmoothScrollToOptions);
    /**
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<SmoothScrollManager, [null, null, { optional: true; }]>;
