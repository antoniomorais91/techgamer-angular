import { AfterViewInit, AfterViewChecked, OnDestroy, OnChanges, SimpleChanges, NgZone, ElementRef, EventEmitter, ChangeDetectorRef, QueryList } from '@angular/core';
...
export declare class GalleryThumbsComponent implements AfterViewInit, AfterViewChecked, OnChanges, OnDestroy {
    ...
    /** Slider ElementRef */
    sliderEl: ElementRef;
    items: QueryList<ElementRef<any>>;
